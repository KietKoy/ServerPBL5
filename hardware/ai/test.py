...
imgTestingNumbers = cv2.imread("E:/PBL5/server/hardware/ai/yolov5/images.jpg")          # read in testing numbers image
# imgTestingNumbers = cv2.resize(imgTestingNumbers, (665, 168))
char=segment_characters(imgTestingNumbers)
...
print(detectChar(imgTestingNumbers))
